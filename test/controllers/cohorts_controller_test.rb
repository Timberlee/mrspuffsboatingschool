...
class CohortsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cohort" do
    assert_difference('Cohort.count') do
      post cohorts_url, params: { cohort: { end_date: @cohort.end_date, instructor: @cohort.instructor, name: @cohort.name, start_date: @cohort.start_date, students: @cohort.students } }
    end
  ...
  test "should update cohort" do
    patch cohort_url(@cohort), params: { cohort: { end_date: @cohort.end_date, instructor: @cohort.instructor, name: @cohort.name, start_date: @cohort.start_date, students: @cohort.students } }
